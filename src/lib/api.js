...
const bookingFromDb = (r) => {
  ...
  return {
    ...
    amountCollected: r.amount_collected != null ? Number(r.amount_collected) : undefined,
...
const bookingToDb = (b) => {
  ...
  return {
    ...
    advance_amount: b.advanceAmount ?? 0, amount_collected: b.amountCollected ?? null, advance_paid: !!b.advancePaid,
